...
def test_imports():
    ...
    try:
        from src.agents.swarm.alice_agent import build_alice_agent
        from src.agents.swarm.bob_agent import build_bob_agent
        from src.agents.swarm.main_agent import build_main_agent
        print("✅ Swarm Agents")
    except ImportError as e:
